(function () {
  ...
  function computeResetViewDate(datepicker) {
    ...
    const viewDate =
      dates.length > 0 ? lastItemOf(dates) : regularizeDate(config.defaultViewDate, config.pickLevel, rangeSideIndex);
  ...
  class Picker {
    constructor(datepicker) {
      ...
      registerListeners(datepicker, [
        ...
        [controls.closeButton, 'click', closeSelection.bind(null, datepicker)],
    ...
    constructor(element, options = {}, rangepicker = undefined) {
      ...
      if (element.tagName === 'INPUT') {
        ...
        if (options.container) {
          ...
          config.container =
            options.container instanceof HTMLElement ? options.container : document.querySelector(options.container);
        }
      } else {
