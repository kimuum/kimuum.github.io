// data 파일 import
import data01 from './data/data_1.js';
import data02 from './data/data_2.js';
import data03 from './data/data_3.js';

const allData = [data01, data02, data03];
...
function convertStructure(data) {
  let deepestDepth = data.headData.length - 4;
  if (data.device === '반응형') {
    deepestDepth = data.headData.length - 5;
  }
