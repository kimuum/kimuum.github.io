...
const HomeContents = {
  ...
  middleFlexArea: [
    ...
    },
    {
      ...
      articleText: (
        <>
          <p>매장에서 ThinQ AI Home 을 직접 경험해볼 수 있어요. </p>
          <p>
            전문가의 친절한 상담을 통해 당신에게 <br />
            필요한 최적의 솔루션도 찾아드려요.
          </p>
        </>
      ),
      articleImage: {
        src: "img_tip_wish_middle_content_04",
        alt: "",
      },
      articleLinkTit: "체험공간 예약하기",
      articleLinkUrl: "",
    },
    {
      textFirst: false,
...
export default HomeTipContentWish9;
