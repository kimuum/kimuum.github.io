...
$.fn.customSelectTxt = function () {
	...
	return this.each(function (i) {
		csBody[i] = $(this);
		csOpenBtn[i] = csBody[i].find('.custom-sel__open');
		csBtn[i] = csBody[i].find('.custom-sel__btn');
		csOpenBtn[i].on('click', function (e) {
			e.preventDefault();
			csBody[i].removeClass('open');
			csBodys.removeClass('open');
...
$.fn.customSelectTxt02 = function () {
	...
	return this.each(function (i) {
		csBody[i] = $(this);
		csOpenBtn[i] = csBody[i].find('.bank-sel__open');
		csBtn[i] = csBody[i].find('.bank-sel__btn');
		csOpenBtn[i].on('click', function (e) {
			e.preventDefault();
			csBody[i].removeClass('open');
			csBodys.removeClass('open');
