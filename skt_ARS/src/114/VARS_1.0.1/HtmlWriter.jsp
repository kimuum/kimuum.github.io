	    ...
	    else
	    {
            ...
            while((line = reader.readLine()) != null) 
            {
			    if(line.matches("[<][Hh][Ee][Aa][Dd][>]"))
			    {
			        ...
			        out.println(line);
			    }else if(line.indexOf("id=\"footer\"") > 0){
			    	line = "<footer id=\"footer\" class=\"sub-footer\" style=\"display: none;\">";
			    	out.println(line);
			    }else if(line.indexOf("id=\"typeTitle\"") > 0){
			    	line = "<p id=\"typeTitle\" class=\"time-notice-sub\" style=\"display: none;\">SKT 보이는 ARS&nbsp;&nbsp;&nbsp;&nbsp;</p>";
			    	out.println(line);
			    }else{
