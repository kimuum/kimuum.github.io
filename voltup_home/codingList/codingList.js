...
$(document).ready(function () {
  ...
  for (var i = 0; i < arry.length; i++) {
    ...
    tableComp +=
      '<table class="coding-list">\
                    <colgroup>\
                      <col class="number" width="70px"/>\
                      <col class="category" width="200px"/>\
    ...
    for (var a = 0; a < arry[i].data.length; a++) {
      for (var b = 0; b < arry[i].data[a]['list'].length; b++) {
        ...
        if (arry[i].data[a].dirRoute) {
          tableComp +=
            '<td class="link">' + '<a href="./' + arry[i].data[a].dirRoute + '/' + arry[i].data[a]['list'][b].fileName + '.html">' + arry[i].data[a]['list'][b].fileName + '.html</a>' + '</td>';
        } else {
          tableComp += '<td class="link">' + '<a href="./' + arry[i].data[a]['list'][b].fileName + '.html">' + arry[i].data[a]['list'][b].fileName + '.html</a>' + '</td>';
        }
